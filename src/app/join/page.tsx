...
export default function JoinPage() {
  ...
  async function onJoin() {
    ...
    try {
      ...
      // After join, go to My tournaments/lists
      r.push("/me");
      r.refresh();
    } catch (e) {
      console.error(e);
...
const btn: React.CSSProperties = { marginTop:10, padding:"12px 16px", borderRadius:12, background:"#0ea5e9", border:"none", color:"#fff", fontWeight:700 };
